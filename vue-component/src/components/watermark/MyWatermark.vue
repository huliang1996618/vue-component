...
import { defineProps, withDefaults, toRefs, computed, shallowRef, ref, onMounted, watch } from 'vue';
import type { CSSProperties } from 'vue';
import { canvasToGray, styleToString } from './util';
...
const contents = computed(() => (Array.isArray(props.content) ? props.content : [props.content]));
